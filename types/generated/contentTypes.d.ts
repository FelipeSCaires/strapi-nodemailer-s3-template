...
export interface ApiAccountPayableAccountPayable
  extends Struct.CollectionTypeSchema {
  collectionName: 'accounts_payable';
  info: {
    description: 'Accounts payable per clinic';
    displayName: 'Account Payable';
    pluralName: 'accounts-payable';
    singularName: 'account-payable';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    amount_remaining: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
    ...
    category: Schema.Attribute.Enumeration<
      ['supplier', 'rent', 'salary', 'utilities', 'tax', 'other']
    > &
      Schema.Attribute.Required;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    creditor_name: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiAccountReceivableAccountReceivable
  extends Struct.CollectionTypeSchema {
  collectionName: 'accounts_receivable';
  info: {
    description: 'Accounts receivable per clinic';
    displayName: 'Account Receivable';
    pluralName: 'accounts-receivable';
    singularName: 'account-receivable';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    amount: Schema.Attribute.Decimal &
      ...
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    amount_received: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
    ...
    > &
      Schema.Attribute.Private;
    notes: Schema.Attribute.Text;
    patient_cpf: Schema.Attribute.String;
    patient_name: Schema.Attribute.String & Schema.Attribute.Required;
    payment_method: Schema.Attribute.Enumeration<
      ['cash', 'card', 'pix', 'insurance']
    >;
    procedure: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    received_date: Schema.Attribute.Date;
    status: Schema.Attribute.Enumeration<
      ['pending', 'overdue', 'received', 'cancelled']
    > &
      Schema.Attribute.DefaultTo<'pending'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiAppointmentAppointment extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Patient appointments per clinic';
  ...
  attributes: {
    account_receivable: Schema.Attribute.Relation<
      'oneToOne',
      'api::account-receivable.account-receivable'
    >;
    clinic: Schema.Attribute.Relation<'manyToOne', 'api::clinic.clinic'> &
    ...
    > &
      Schema.Attribute.Private;
    notes: Schema.Attribute.Text;
    patient_email: Schema.Attribute.Email;
    patient_name: Schema.Attribute.String & Schema.Attribute.Required;
    patient_phone: Schema.Attribute.String;
    procedure: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiClinicClinic extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Tenant entity for multitenant architecture';
    displayName: 'Clinic';
    pluralName: 'clinics';
    singularName: 'clinic';
  };
  ...
  attributes: {
    accounts_payable: Schema.Attribute.Relation<
      'oneToMany',
      'api::account-payable.account-payable'
    >;
    accounts_receivable: Schema.Attribute.Relation<
      'oneToMany',
      'api::account-receivable.account-receivable'
    >;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    credit_limit: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    credit_used: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    ...
    slug: Schema.Attribute.UID<'name'> & Schema.Attribute.Required;
    status: Schema.Attribute.Enumeration<['active', 'suspended', 'inactive']> &
      Schema.Attribute.DefaultTo<'active'>;
    supplier_contracts: Schema.Attribute.Relation<
      'oneToMany',
      'api::supplier-contract.supplier-contract'
    >;
...
export interface ApiInventoryItemInventoryItem
  ...
  info: {
    description: 'Clinic inventory stock per product';
  ...
  attributes: {
    ...
    last_purchase_date: Schema.Attribute.Date;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::inventory-item.inventory-item'
    ...
    total_value: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
...
export interface ApiInventoryMovementInventoryMovement
  ...
  attributes: {
    ...
    quantity_after: Schema.Attribute.Integer & Schema.Attribute.Required;
    quantity_before: Schema.Attribute.Integer & Schema.Attribute.Required;
    reason: Schema.Attribute.Enumeration<
      ['purchase', 'sale', 'adjustment', 'waste', 'return']
    > &
      Schema.Attribute.Required;
    reference_id: Schema.Attribute.BigInteger;
...
export interface ApiInvoiceInvoice extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    access_key: Schema.Attribute.String;
    clinic: Schema.Attribute.Relation<'manyToOne', 'api::clinic.clinic'> &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    publishedAt: Schema.Attribute.DateTime;
    status: Schema.Attribute.Enumeration<['issued', 'cancelled', 'rectified']> &
    ...
    total: Schema.Attribute.Decimal &
      ...
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    type: Schema.Attribute.Enumeration<['nfe', 'nfse', 'receipt']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    xml_file: Schema.Attribute.Media<'files'>;
  };
}
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Purchase orders from clinic to supplier';
    displayName: 'Order';
    pluralName: 'orders';
    singularName: 'order';
  };
  ...
  attributes: {
    account_payable: Schema.Attribute.Relation<
      'oneToOne',
      'api::account-payable.account-payable'
    >;
    clinic: Schema.Attribute.Relation<'manyToOne', 'api::clinic.clinic'> &
    ...
    delivery_address: Schema.Attribute.JSON;
    discount: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
      ...
      > &
      Schema.Attribute.DefaultTo<0>;
    estimated_delivery: Schema.Attribute.Date;
    ...
    order_number: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    payment_due_date: Schema.Attribute.Date;
    payment_method: Schema.Attribute.Enumeration<
      ['credit', 'boleto', 'pix', 'card']
    >;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    requires_prescription: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    ...
    stock_supplier: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
    ...
    unit: Schema.Attribute.Enumeration<['unit', 'box', 'kg', 'liter']> &
      Schema.Attribute.DefaultTo<'unit'>;
    units_per_package: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 1;
        },
...
export interface ApiSupplierContractSupplierContract
  extends Struct.CollectionTypeSchema {
  collectionName: 'supplier_contracts';
  info: {
    description: 'Contract relationship between Clinic and Supplier';
    displayName: 'Supplier Contract';
    pluralName: 'supplier-contracts';
    singularName: 'supplier-contract';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    credit_limit: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    delivery_terms: Schema.Attribute.String;
    ...
    > &
      Schema.Attribute.Private;
    payment_terms: Schema.Attribute.JSON;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiSupplierSupplier extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Shared supplier entity';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    delivery_areas: Schema.Attribute.JSON;
    description: Schema.Attribute.Text;
    email: Schema.Attribute.Email & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
    ...
    min_order_value: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    orders: Schema.Attribute.Relation<'oneToMany', 'api::order.order'>;
    payment_terms: Schema.Attribute.JSON;
    phone: Schema.Attribute.String;
...
export interface ApiTransactionTransaction extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Financial transactions per clinic';
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['order', 'payment', 'refund', 'fee', 'adjustment', 'procedure']
    > &
      Schema.Attribute.Required;
    clinic: Schema.Attribute.Relation<'manyToOne', 'api::clinic.clinic'> &
      Schema.Attribute.Required;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::account-payable.account-payable': ApiAccountPayableAccountPayable;
      'api::account-receivable.account-receivable': ApiAccountReceivableAccountReceivable;
      ...
      'api::supplier-contract.supplier-contract': ApiSupplierContractSupplierContract;
